...
- Enemy startup draws a ground ring: ember for lunge/slam, ice for snuff spit. The ring is a wedge that faces the enemy, spans the attack's half-angle, and tightens inward as the startup clock nears contact.
