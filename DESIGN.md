...
- Audio is a quiet synthesized mix with no assets: slam, spit, oil, grit, flare, ring, hit, lunge, kill, pickup, shrine, win, lose, wave, denied. It plays sim events only — it never invents hits, pickups, or fuel.
