...
The wickwarden swing is short and honest. The ash wight lunge is longer in startup so a player who watched the ember wedge can step out. Snuff spit uses an ice wedge that points the way the snuffer is aiming, tightens as contact nears, and flashes in the final beat. Do not add an unpunishable move.
