...
const SHELL=['./','./index.html','./runner/style.css','./runner/main.js','./runner/content.js','./runner/sim.js','./runner/profile.js','./runner/render.js','./runner/audio.js','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png','./manifest.webmanifest'];
